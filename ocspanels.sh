...
read -p "Password baru: " -e -i Borneo123 DatabasePass
echo ""
...
curl https://raw.githubusercontent.com/borneocyberphreak/borneofiles/master/ocspanels/nginx.conf > /etc/nginx/nginx.conf
curl https://raw.githubusercontent.com/borneocyberphreak/borneofiles/master/ocspanels/vps.conf > /etc/nginx/conf.d/vps.conf
...
#install package ocs-panels.zip
apt-get install unzip
cd /home/vps/public_html
wget https://raw.githubusercontent.com/borneocyberphreak/borneofiles/master/ocspanels/ocspanels.zip
unzip ocspanels.zip
